...
const DEFAULT_GLOW_COLOR = "255, 34, 57";
...
const cardData = [
  ...
  },
  {
    ...
    title: "What I Do",
    label:
      "• Responsive, high-quality interfaces\n• Fast React/Next.js builds\n• Smooth motion & micro-interactions",
  },
  {
    color: "#190408",
    title: "My Story",
...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid gap-2 p-3 w-[85vw] select-none relative"
              ...
              return (
                ...
                >
                  <div className="card__header flex justify-between relative text-white">
                    <span className="card__title font-[anzo1] text-base whitespace-pre-line">
                      {card.title}
                    </span>
                  </div>
                  <div className="card__header flex justify-between gap-3 relative text-white">
                    {Array.isArray(card.label) ? (
                      // Render SOCIAL LINK ITEMS (Find Me Online)
                      <div className="flex flex-col gap-2">
                        {card.label.map((item, index) => {
                          const Icon = icons[item.icon]; // maps icon name to JSX component
                          return (
                            <a
                              key={index}
                              href={item.link}
                            ...
                            >
                              <Icon size={18} />
                              <span className="font-[anzo3] text-base">
                                {item.text}
                              </span>
                            </a>
                          );
                      ...
                      // Render NORMAL TEXT BOXES
                      <span className="card__label font-[anzo3] text-base whitespace-pre-line">
                        {" "}
                        {card.label}{" "}
                      </span>
                    )}
